...
const Footer = () => {
  ...
  return (
    <footer>
      {/* footer top */}
      <div className="max-w-screen-2xl container mx-auto xl:px-28 px-4 border-t-[2px] border-gray-300">
        <div className="mt-10 mb-10 flex flex-col md:flex-row items-center justify-between gap-8">
          {/* company info */}
          ...
          {/* ABOUT US */}
          <div className="text-Black">
            <h4 className="font-semibold mb-3 text-center">ABOUT US</h4>
            <div className="space-y-2 text-center">
              <Link to="/" className="text-sm block hover:text-orange-500">
                Our Producers
              </Link>
      ...
      <div className="bg-gray-600">
        <p className="text-white text-center items-center py-3">© {currentYear} Nik_Johnz</p>
      </div>
    </footer>
  );
};
